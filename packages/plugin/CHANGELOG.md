...
| @vitest-agent/cli | dependency | updated | 3.1.5 | 3.1.6 |
| @vitest-agent/engine | dependency | updated | 0.2.5 | 0.2.6 |
| @vitest-agent/mcp | dependency | updated | 4.3.1 | 4.3.2 |
| magic-string | dependency | updated | ^1.4.1 | ^1.4.2 |
...
| @vitest-agent/cli | dependency | updated | 3.1.4 | 3.1.5 |
| @vitest-agent/engine | dependency | updated | 0.2.4 | 0.2.5 |
| @vitest-agent/mcp | dependency | updated | 4.3.0 | 4.3.1 |
| @vitest-agent/reporter | dependency | updated | 3.1.1 | 3.1.2 |
...
| @vitest-agent/cli | dependency | updated | 3.1.3 | 3.1.4 |
| @vitest-agent/engine | dependency | updated | 0.2.3 | 0.2.4 |
| @vitest-agent/mcp | dependency | updated | 4.2.1 | 4.2.2 |
...
| @vitest-agent/cli | dependency | updated | 3.1.0 | 3.1.1 |
| @vitest-agent/engine | dependency | updated | 0.2.0 | 0.2.1 |
| @vitest-agent/mcp | dependency | updated | 4.1.0 | 4.1.1 |
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| magic-string | dependency | updated | ^1.3.1 | ^1.4.1 |
...
[#454]: https://github.com/spencerbeggs/vitest-agent/pull/454
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @vitest-agent/cli | dependency | updated | 3.0.1 | 3.0.2 |
| @vitest-agent/engine | dependency | updated | 0.1.1 | 0.1.2 |
| @vitest-agent/mcp | dependency | updated | 4.0.1 | 4.0.2 |
| @vitest-agent/reporter | dependency | updated | 3.0.4 | 3.0.5 |
...
- `@vitest-agent/cli` and `@vitest-agent/mcp` are regular exact-pinned dependencies of the plugin, and the plugin now depends on `@vitest-agent/engine` for its platform layer. [#420][#420]
...
| @vitest-agent/cli | dependency | updated | 2.2.19 | 3.0.0 |
| @vitest-agent/mcp | dependency | updated | 3.0.4 | 4.0.0 |
| @vitest-agent/reporter | dependency | updated | 3.0.3 | 3.0.4 |
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @vitest-agent/mcp | dependency | updated | 3.0.3 | 3.0.4 |
| magic-string | dependency | updated | ^1.2.3 | ^1.3.1 |
...
| @vitest-agent/cli | dependency | updated | 2.2.18 | 2.2.19 |
| @vitest-agent/mcp | dependency | updated | 3.0.2 | 3.0.3 |
| @vitest-agent/reporter | dependency | updated | 3.0.2 | 3.0.3 |
