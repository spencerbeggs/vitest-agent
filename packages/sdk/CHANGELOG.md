...
- Anyone who imported the old subpath directly, or validated `run.json` against the old URL, needs to update to the new path and URL. [#452][#452]

### Thanks

Thanks to [@spencerbeggs](https://github.com/apps/spencerbeggs) for their contributions!

[#452]: https://github.com/spencerbeggs/vitest-agent/pull/452
...
- `CURRENT_SDK_VERSION` is unchanged. [#420][#420]
...
| @effected/config-file | dependency | removed | ^0.8.0 | — |
| @effected/jsonc | dependency | removed | ^0.11.0 | — |
| @effected/toml | dependency | removed | ^0.7.0 | — |
| @effected/walker | dependency | removed | ^0.8.0 | — |
| @effected/workspaces | dependency | removed | ^0.21.0 | — |
| @effected/xdg | dependency | removed | ^0.5.0 | — |
| @effected/yaml | dependency | removed | ^0.15.0 | — |
| ajv | dependency | removed | ^8.20.0 | — |
...
- A duplicate test title no longer aborts history persistence for the run. [#380][#380]

### Tests

- The shared test-layer presets record `vitestVersion: "5.0.0"`. [#380][#380]
