...
export const SERVER_INSTRUCTIONS = [
	...
	"An expected domain error (a missing goal, an illegal phase transition, a refused registration) is NOT an isError result: it is a normal result whose structuredContent has ok: false and an error with _tag, message and a remediation naming the tool to call next.",
