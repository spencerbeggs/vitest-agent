/**
 * tsdown SEA build config for `vitest-agent-sidecar-linux-x64`.
 *
 * This child package compiles ITS OWN platform binary — a Node Single
 * Executable Application (SEA) for `linux/x64` only. The five
...
const TARGET = { platform: "linux", arch: "x64", nodeVersion: "25.9.0" } as const;
